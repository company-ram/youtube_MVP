...
const add_views = async (req, res) => {
    try {
        ...
        // =========================
        // 7. Make sure views is a number
        // =========================

        const current_views = Number(find_video.views);

        if (!Number.isFinite(current_views)) {
            return res.status(500).json({
                success: false,
                message: "Video views value is invalid"
            });
        }
